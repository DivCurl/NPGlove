#include "include/anPalmPulseNoStrobeSA.h"
...
anPalmPulseNoStrobeSA::anPalmPulseNoStrobeSA( npDisplay* pDisplay, mode_t mode, int frames, opt_t opts, scale_t customScaling ) 
: npAnimation( pDisplay, mode, frames, opts, customScaling ) { 
    analyzerRun = 1;   
    InitFFT();
}

anPalmPulseNoStrobeSA::~anPalmPulseNoStrobeSA() { 
    analyzerRun = 0;
}

// STRICTLY FOR TESTING //
int anPalmPulseNoStrobeSA::Draw() {
    int strobe = 0;    
    ...
    while ( ( framesDrawn < frames ) || modeFlags.test( MODE_REPEAT ) ) {        
        ...
        */   
            ...
            peakPalm = Remap( peakVol, -55, 0, 0, 15 );
